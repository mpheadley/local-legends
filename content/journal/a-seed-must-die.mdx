...
*[Watch the service on Facebook →](https://www.facebook.com/share/19272nPHof/?mibextid=wwXIfr) — sermon begins at 25:40*
...
<p style={{fontSize:'0.65rem',fontWeight:700,letterSpacing:'0.18em',textTransform:'uppercase',color:'var(--color-mute)',marginBottom:'0.25rem',opacity:0.6}}>Stage I · Upset the Equilibrium</p>
...
<p style={{fontSize:'0.65rem',fontWeight:700,letterSpacing:'0.18em',textTransform:'uppercase',color:'var(--color-mute)',marginBottom:'0.25rem',opacity:0.6}}>Stage II · Analyze the Discrepancy</p>
...
<p style={{fontSize:'0.65rem',fontWeight:700,letterSpacing:'0.18em',textTransform:'uppercase',color:'var(--color-mute)',marginBottom:'0.25rem',opacity:0.6}}>Stage IV · Experience the Gospel</p>
...
<p style={{fontSize:'0.65rem',fontWeight:700,letterSpacing:'0.18em',textTransform:'uppercase',color:'var(--color-mute)',marginBottom:'0.25rem',opacity:0.6}}>Stage V · Anticipate the Consequences</p>
