...
**Headley Flower Farm journal entry** (`headley-flower-farm.md`) — **HIGH PRIORITY.** `/about#farm` is a working anchor on the about page — not a dead link. The farm piece is the right destination for readers who want more than the about page summary, but it's not blocking anything live. Write this when ready, not urgently.
...
| `ai-writing-process-seeds.md` | Three phases: AI as mania amplifier → depression dump → creative partner now | Seed — dependency (`the-same-domain.mdx`) now published, ready |
| `depression-mania-recovery-contrast.md` | Behavioral contrast: what each state actually looks like day to day, what recovery is (10 min, morning light, writing) | Seed — April 2026 voice memo |
| `cropwell.md` | The month in the camper — separated from family, the geography of fear | Seed |
| `mania-resignation-farm.md` | The causal chain told plainly: mania → felt like calling → resignation → farm → collapse | Seed |
...
| `first-methodist-anniston.md` *(seed — not yet created)* | Matt's years at Anniston First UMC as music director and associate pastor — the bait-and-switch hire, the fight for the title and raise, roaming the Gurnee neighborhood, the resignation morning. Source material in `ministry-grief.md` (Anniston First sections). Links from: Lewis Downing profile opening. | Seed — draft in a dedicated session |
...
| `farmers-market-pastoral-parallels.md` | Pastoral ministry parallels with the City of Anniston Farmers Market Manager role. Same instinct — holding a community — without the 2am pages. The relief of pastoral attention without pastoral burden. | Seed — **HOLD until end of first market season (Sept 2026+).** Needs lived material; do not publish before being hired or working a full season. |
...
| File | Why |
|------|-----|
| `psilocybin.md` | Schedule I substance, Alabama, client risk. Do not name Barnhart without consent. |
