# Headley Flower Farm — Journal Entry Draft
...
- Anniston Star articles written about the farm (others' writing — link from within the entry, don't republish)
- Patreon posts: `patreon-leavings-are-tough.md` (April 2025 — Ash Wednesday departure, beginning of farm chapter), `patreon-mobile-pulpit.md` (July 2025 — the farm still running, pulpit is mobile now), `patreon-behind-the-blooms-july-update.md` (July 2025 — à la carte weddings, resin jewelry, Sunny the dog)
- `manic-episode.md` in this folder — covers the 16-20 hour days, wild success feeling, farm scaling during mania
- `the-farm-sale.md` in this folder — the yard sale Heather ran alone, frozen, walking in circles
...
## Scaffold prompts (for Matt to write into)

**Opening scene** *(Matt writes — do not draft)*
A specific moment on the farm. Not the beginning, not the end. A Tuesday in the middle of it. What were you doing, what did it smell like, what was underfoot.

**The beginning**
How it started. The Chief Ladiga Trail kiosk. First market. Heather's role. The kids.

**The manic chapter** *(Matt writes — vulnerable, do not draft)*
The 16-20 hour days. What wild success felt like from the inside. What Heather was watching.

**The farm at its best**
What it actually was at peak — the trailer, the markets, the regulars, the flowers. Use the trailer photo here.

**The end**
The farm sale. What "we came home to a farm that was up for sale" actually means on the ground. The yard sale. Walking in circles. (Already told in the reintroduction — don't repeat; go deeper or go to a different moment.)

**Now**
`headleyflowerfarm.com` is inactive. The equipment is somewhere. Heather may still have weddings booked (verify). What remains.
