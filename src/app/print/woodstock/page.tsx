...
const WOODSTOCK: Shirt[] = [
  ...
  { id: 'W9',  label: 'Blossom & Decay',                   color: 'Mocha',        note: 'Art crowd · conversation piece',   img: '/print-files/WOODSTOCK-09-blossom-decay-MOCHA.png',             bg: '#6b4c35', price: '$35', method: 'DTF',        dims: '10" × 10"',   file: 'WOODSTOCK-09-blossom-decay-MOCHA.png',             sizes: { s: 0, m: 1, l: 1, xl: 1, xxl: 0 } },
